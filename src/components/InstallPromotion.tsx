...
const InstallPromotion = () => {
    const {showInstallPromotion, showGuidePromotionIOS, setShowGuidePromotionIOS, deferredPrompt, setDeferredPrompt, isIos} = useInstallPrompt()
    return (
        <NoSsr>
    ...
    function installPromotionHandler() {
        if(isIos) {
            return setShowGuidePromotionIOS(true)
        } else {
            return async () => {
